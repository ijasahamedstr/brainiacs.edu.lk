...
import StudentRegistrationManager from "../StudentRegistration/StudentRegistration";
import AcademicStaffManager from "../Academic Staffs/Academic Staffs";
...
const Dashboard: React.FC = () => {
  ...
  const NAVIGATION_MAP: NavItem[] = useMemo(() => [
    ...
    { 
      text: "Academic Staffs", icon: <PeopleAltOutlined />,
    },
    { 
  ...
  const ActiveContent = () => {
    switch (activeTab) {
      ...
      case "All Courses": return <CourseManager />;
      ...
      case "Student Registration": return <StudentRegistrationManager />;

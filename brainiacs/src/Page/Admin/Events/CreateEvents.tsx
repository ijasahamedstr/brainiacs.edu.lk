...
import { 
  ...
  CloudUploadOutlined, CollectionsOutlined, HideImageOutlined
            ...
            <Stack direction="row" justifyContent="space-between" mb={1}>
              ...
              <Stack direction="row" spacing={1}>
                ...
                <input 
                  ...
                  multiple 
                  accept="image/*" 
                  id="bulk-upload-event" 
                  style={{ display: "none" }}
                  onChange={handleBulkUpload}
                />
                <label htmlFor="bulk-upload-event">
                  <Button 
                    component="span" 
                    size="small" 
              ...
              {imageUrls.map((url, index) => (
                <Stack key={index} direction="row" spacing={1} alignItems="center">
                  ...
                  <TextField 
                    ...
                    sx={inputStyle} 
                  />
                  <IconButton onClick={() => handleRemoveImageUrl(index)} color="error" disabled={imageUrls.length === 1}><DeleteOutline /></IconButton>
                </Stack>
              ))}
            </Stack>
          </Box>
